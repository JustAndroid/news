            ...
            alertDialog.setOnShowListener(new DialogInterface.OnShowListener() {
                ...
                public void onShow(DialogInterface dialogInterface) {
                    ...
                    if (Build.VERSION.SDK_INT >= 16) {
                       ...
                       positiveButton.setBackground(context.getResources().getDrawable(R.drawable.custom_button));


                    }else {

                        positiveButton.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.custom_button));
